...
from ...common_utils.model_types import Namelist
...
def get_r_config(
    ...
    params = {
        'stilt_wd': namelist.stilt_wd,
        'n_cores': namelist.n_cores,
        't_start': namelist.t_start,
        't_end': namelist.t_end,
        'lati': namelist.lati,
        'long': namelist.long,
        'zagl': namelist.zagl,
        'xmn': namelist.xmn,
    ...
    template = Template(r_template)
    r_script = template.render(params)
    return r_script


if __name__ == '__main__':
    param = Namelist(
        stilt_wd='/home/lin-kp/stilt',
        t_start='2021-06-01 00:00:00',
        t_end='2021-06-01 01:00:00',
        lati=40.0,
        long=-105.0,
        zagl=100.0,
        xmn=-106.0,
